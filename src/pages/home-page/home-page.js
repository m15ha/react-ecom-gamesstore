...
const GAMES = [
    ...
    {
        image: process.env.PUBLIC_URL + '/game-covers/battlefield_2042.jpg',
    ...
    {
        image: process.env.PUBLIC_URL + '/game-covers/gta_v.jpeg',
    ...
    {
        image: process.env.PUBLIC_URL + '/game-covers/rainbow_siege.jpeg',
    ...
    {
        image: process.env.PUBLIC_URL + '/game-covers/assassins_creed_valhalla.png',
